    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_viaje', models.CharField(default='sin asignar', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.TextField(default='Pendiente', max_length=30)),
                ('vendor', models.ForeignKey(default='vacio', null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendor.Vendor')),
            ],
        ),
    ]
